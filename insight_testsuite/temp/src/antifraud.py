...
#df.columns = ['time','id1','id2','amount','messge']
#id1 = df['id1']
#id2 = df['id2']
#id1_clean = id1.drop_duplicates()
#id2_clean = id2.drop_duplicates()
#edge_raw = df_batch[['id1','id2']]
...
#if DFSFeatureone(g,Node(6860),Node(34),path=[]):
#    print 'trusted'
#else:
#    print 'unverified'
